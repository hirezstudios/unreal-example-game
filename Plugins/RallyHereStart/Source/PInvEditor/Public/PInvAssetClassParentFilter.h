...
class PINVEDITOR_API FPInvAssetClassParentFilter : public IClassViewerFilter
{
public:
...
TSharedPtr<FPInvAssetClassParentFilter> Filter = MakeShareable(new FPInvAssetClassParentFilter); \
