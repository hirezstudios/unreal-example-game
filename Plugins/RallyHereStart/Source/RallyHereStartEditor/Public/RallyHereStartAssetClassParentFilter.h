...
class RALLYHERESTARTEDITOR_API FRallyHereStartAssetClassParentFilter : public IClassViewerFilter
{
public:
...
TSharedPtr<FRallyHereStartAssetClassParentFilter> Filter = MakeShareable(new FRallyHereStartAssetClassParentFilter); \
